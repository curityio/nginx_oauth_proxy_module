...
COPY --from=ubuntu22-builder /tmp/nginx-$NGINX_VERSION/objs/ngx_curity_http_oauth_proxy_module.so /build/ubuntu.22.04.ngx_curity_http_oauth_proxy_module_$NGINX_VERSION.so
...
COPY --from=centos-stream9-builder /tmp/nginx-$NGINX_VERSION/objs/ngx_curity_http_oauth_proxy_module.so /build/centos.stream.9.ngx_curity_http_oauth_proxy_module_$NGINX_VERSION.so
...
COPY --from=debian11-builder /tmp/nginx-$NGINX_VERSION/objs/ngx_curity_http_oauth_proxy_module.so /build/debian.bullseye.ngx_curity_http_oauth_proxy_module_$NGINX_VERSION.so
COPY --from=debian12-builder /tmp/nginx-$NGINX_VERSION/objs/ngx_curity_http_oauth_proxy_module.so /build/debian.bookworm.ngx_curity_http_oauth_proxy_module_$NGINX_VERSION.so
...
COPY --from=amzn2023-builder /tmp/nginx-$NGINX_VERSION/objs/ngx_curity_http_oauth_proxy_module.so /build/amzn2023.ngx_curity_http_oauth_proxy_module_$NGINX_VERSION.so
